class Game {
  constructor() {
    ...
    this.background.src = "/MAO-GAME/images/background.png";
    this.mao = new Mao();
    //this.landlord = new landlord(); //
    this.landlordArr = [new Landlord("/MAO-GAME/images/landlord.png")];
  ...
  addlandies = () => {
    ...
    if (lastLandlord.landlordY > 200) {
      this.landlordArr.push(new Landlord("/MAO-GAME/images/landlord.png"));
    }
  };
